...
# Bot information
SESSION = environ.get('SESSION', 'Movie adda')
API_ID = int(environ.get('API_ID', '27157998'))
API_HASH = environ.get('API_HASH', '45d09c93e37c9b93b6535949c898f906')
BOT_TOKEN = environ.get('BOT_TOKEN', "6125833213:AAFb8Gh4S8nMsSabULgWw0SUKNp5yO8q5aI")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001912073683').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1452198353').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movieaddaSupport')
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adaa™](https://t.me/moviieeadda3)</b>⚡\n\nName: {file_caption} \n\n⚙️ <b>Size: </b><code>{file_size}</code>🔥  ↭ <b>Join Now [MoviesAdda™](https://t.me/moviieeadda2)</b> ↭  🔥")
...
DOWNLOAD_TEXT_URL = "https://t.me/mr_chaudhary620"

   # Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/moviieeadda2"
