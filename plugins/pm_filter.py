import os
REQ_channel = int(os.environ.get('REQ_CHANNEL', '-1001988418193'))
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡Main Channel ⚡", url='https://telegram.me/moviieeadda2')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/moviieeadda2"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/mr_chaudhary620')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡Movie Update ⚡", url='https://telegram.me/moviieeadda2')
        ]
    )
